    ...
    <div class="container menuAuto">
      ...
      <form action="dodajwyd.php" method="POST">
          <div class="form-group">
            ...
            <input type="text" name="nazwa" class="form-control form-control-sm" id="nazwa" placeholder="Wprowadź nazwę wydawnictwa" required>
          </div>
          <div class="form-group">
            <label for="address">Adres:</label>
            <input type="text" name="adress" class="form-control form-control-sm" id="adress" placeholder="Wprowadź adres wydawnictwa" required>
          </div>
          <div class="form-group">
            <label for="email">Email:</label>
            <input type="email" name="email" class="form-control form-control-sm" id="email" placeholder="Wprowadź email wydawnictwa" required>
          </div>
          <div class="form-group">
            <label for="telefon">Telefon:</label>
            <input type="number" name="telefon" class="form-control form-control-sm" id="telefon" placeholder="Wprowadź numer telefonu wydawnictwa" required>
          </div>
          <button type="submit" class="btn btn-primary">Dodaj wydawnictwo</button>
      </form>
