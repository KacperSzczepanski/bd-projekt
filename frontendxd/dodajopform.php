<!DOCTYPE HTML>
  <HEAD>
    <TITLE> Dodaj opinię do książki </TITLE>
    <meta charset="utf-8">
    ...
    <div class="container menu40">
      ...
      ?>
        <div class="form-group">
          <label for="val">Ocena:</label>
          <input type="range" value="5" id="val" name="val" min="0" max="10" class="from-control-range" oninput="this.nextElementSibling.value = this.value">
          <output>5</output>
        </div>
        <div class="form-group">
          <label for="tru">Poziom trudności:</label>
          <input type="range" value="5" id="tru" name="tru" min="0" max="10" class="from-control-range" oninput="this.nextElementSibling.value = this.value">
          <output>5</output>
        </div>
        <div class="form-group">
          <label for="opis">Opis:</label>
          <textarea name="opis" rows="5" style="width: 100%; border-radius: 5px" placeholder="Treść opinii"></textarea>
        </div>
